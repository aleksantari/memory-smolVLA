---
title: "Memory-Augmented SmolVLA: Brief Report"
subtitle: "memvla_libero, condensed"
...
header-includes:
  ...
  - \pagestyle{fancy}
  - '\fancyhead[L]{Memory-SmolVLA: Brief}'
  - \fancyhead[R]{\thepage}
  - \fancyfoot{}
---
...
| LeRobot SmolVLA (2025) | [lerobot](https://github.com/huggingface/lerobot/tree/main/src/lerobot/policies/smolvla) | `embed_prefix`, `SmolVLMWithExpertModel.forward`. |

For full procedure, drawback analysis, bypass-ablation framing, and V1-iteration history, see `report.md` (24 pages).
