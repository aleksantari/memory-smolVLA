...
#
# Usage: nohup bash scripts/run_v7_supervised.sh configs/memvla_libero_v9.yaml > .train_v7.log 2>&1 &

set -u
CONFIG="${1:-configs/memvla_libero_v9.yaml}"
...
CKPT_DIR="$ROOT/checkpoints/memvla_libero_v9"
MAX_FAILS=12
fails=0
attempt=0
